...
class DatePicker{
  ...
  setHeaderYearAndMonthRange(){
      ...
      for (let i=startYear ; i<=endYear; i++){
        ...
        // option.value=i;
        // option.text=i;
        //document.querySelector().appendChild(option);
      }

      // console.log(moment(new Date(this.startDate)).format('YYYY-MM-DD'));
      ...
      // console.log(iterationDate, iterationDateYYYYMM, endDateYYYYMM);
    ...
    renderDays(){
     ...
     monthArray.forEach((day, index)=>{
        ...
        const calenderRows = document.querySelectorAll(`#datepicker-${this.uid} .datepicker-calendar-body__days-row`);
  ...
  changeMonth(value){
    ...
    if(this.startDate.substr(0,7)<= newDate && this.endDate.substr(0,7)>= newDate){
